      ...
      <section className="relative">
        ...
        <div className="flex flex-col">
          <div className="flex justify-between">
            ...
            <div className="absolute top-5 left-1/2 w-fit transform -translate-x-1/2 max-md:hidden">
          ...
          <div className="w-full items-center gap-10">
            <div className="absolute top-[30%] left-1/2 -translate-x-1/2 flex flex-col w-full justify-center items-center gap-10">
              ...
              <p className="text-white text-4xl md:text-7xl tracking-[0.2rem] font-bold font-comfortaa text-center">
            ...
            <div className="flex gap-10 w-[80%] absolute left-1/2 -translate-x-1/2 bottom-5 max-md:hidden">
              ...
              <div className="flex flex-col justify-center items-center flex-1 gap-3">
                ...
                <p className="text-gray-300 font-sans text-xl leading-8 text-center">
                  Athletic opportunities to enhance physical abilities and
                  foster teamwork.
                </p>
              </div>
              <div className="flex flex-col justify-center items-center flex-1 gap-3">
